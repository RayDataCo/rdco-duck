    ...
    create  table
      "dbt"."main"."mrr_customer_revenue_by_month__dbt_tmp"
    as (
      with
    subscription_periods as (select * from "dbt"."main"."mrr_subscription_periods"),

    months as (select * from "dbt"."main"."mrr_utils_months"),
    ...
    customer_months as (
        ...
        select customers.customer_id, months.date_month
    ...
    -- join the account-month spine to MRR base model, pulling through most recent
    -- dates
